...
def normalization(img, axis=None): 
...
def TestOperation(ImgPH, ImageSize, ModelPath, DataPath, LabelsPathPred):
    ...
    _, prSoftMaxS = CIFAR10Model(ImgPH, ImageSize, 1, False)
...
def main():
    ...
    """
    modelName = 'ResNet' # MyNet, ResNet, DenseNet, ResNeXt
    # Parse Command Line arguments
    Parser = argparse.ArgumentParser()
    Parser.add_argument('--ModelPath', dest='ModelPath', default='goodCheck/'+modelName+'Bestmodel.ckpt', help='Path to load latest model from, Default:ModelPath')
